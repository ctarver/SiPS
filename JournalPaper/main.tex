...
{\color{red} The undesirable effects from the PA nonlinearities are exacerbated by modern, multicarrier signals such as OFDM due to their high peak-to-average power ratio (PAPR) \cite{Ghannouchi09}. Techniques such as crest factor reduction (CFR) can help reduce the PAPR of these signals by limiting the peak power. However, this does nothing to try to actually linearize the PA response. So although it may help, it is not usually enough.} 
