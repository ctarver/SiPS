...
This is particularly challenging when we compound this with the growing number of wireless devices  \cite{Cisco16}.
...
{\color{red} For example, if carriers exist at frequencies $f_1$ and $f_2$, there will be third-order IMD products (IM3s) at frequencies of $2f_1 - f_2$ and $2f_2 - f_1$.}
