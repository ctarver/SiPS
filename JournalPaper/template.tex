...
Also whenever the DPD coefficients converge, they can be stored in the memory.
This serves as a starting point for whenever the transmission scenarios are repeated. 
Also, whenever we do a new scenario, we can use the values from other scenarios to interpolate an estimate of the DPD coefficients for the new scenario. This serves as a starting point to help rapidly converge.
